...
public class TestesAc01 {
	...
	public void testBilhete1() {
		...
		Assertions.assertEquals(900.0, bil.obterValorPago());
		Assertions.assertEquals(45.0, bil.obterValorPontuacao());
		BilheteVip bilVip = new BilheteVip(null, null, 1000, 200, null, 20);		
		Assertions.assertEquals(48.0, bilVip.obterValorPontuacaoVip());			
	}
	@Test
